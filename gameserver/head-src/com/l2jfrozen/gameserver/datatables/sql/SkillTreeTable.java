	...
	private SkillTreeTable()
	{
		...
		try
		{
			...
			while (skilltree3.next())
			{
				...
				//changed
				final byte rate76 = skilltree3.getByte("success_rate80");
				final byte rate77 = skilltree3.getByte("success_rate80");
				final byte rate78 = skilltree3.getByte("success_rate80");
				final byte rate79 = skilltree3.getByte("success_rate80");
