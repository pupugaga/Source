...
public class L2FolkInstance extends L2NpcInstance {
    ...
    public void showSkillList(final L2PcInstance player, final ClassId classId) {
        ...
        Announcements.getInstance().announceToAll("" + npcId);
    ...
    public void showEnchantSkillList(final L2PcInstance player, final ClassId classId) {
        ...
        for (final L2EnchantSkillLearn s : skills) {
            ...
            if (sk == null ||( s.getLevel() == 154 &&player.getLastFolkNPC() instanceof L2DonateShopInstance) || (s.getLevel() == 155 && player.getLastFolkNPC() instanceof L2DonateShopInstance) ||( s.getLevel() == 114 &&player.getLastFolkNPC() instanceof L2DonateShopInstance) || (s.getLevel() == 115 &&player.getLastFolkNPC() instanceof L2DonateShopInstance)) {
                continue;
            }
            counts++;
